...
Revision ID: 2d4e911c9e62
Revises: 
Create Date: 2018-10-18 15:18:21.002309
...
def upgrade():
    ...
    sa.Column('gender', sa.Enum('MALE', 'FEMALE', 'SECRET', 'UNKOWN', name='genderenum'), nullable=True),
    sa.Column('join_time', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('email'),
